...
Dengan menggunakan teknik augmentasi data, diharapkan dapat meningkatkan akurasi klasifikasi handwritten digit images yang rendah sehingga model dapat mempelajari pola pada data dengan lebih baik.